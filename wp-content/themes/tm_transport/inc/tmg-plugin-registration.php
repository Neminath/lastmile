  ...
  function thememove_register_theme_plugins()
  {
    ...
    $plugins = array(
      array(
        'name'               => 'ThemeMove Core',
        'slug'               => 'thememove-core',
        'source'             => 'https://github.com/vunamhung/TM_Plugins/blob/master/thememove-core.zip?raw=true',
        'version'            => '1.1',
        'required'           => true,
      ...
      array(
        ...
        'slug'               => 'js_composer',
        'source'             => 'https://github.com/vunamhung/TM_Plugins/blob/master/js_composer.zip?raw=true',
        'version'            => '4.6',
        'required'           => true,
      ...
      array(
        'name'               => 'Essential Grid',
        'slug'               => 'essential-grid',
        'source'             => 'https://github.com/vunamhung/TM_Plugins/blob/master/essential-grid.zip?raw=true',
        'version'            => '2.0.9',
        'required'           => true,
        'force_activation'   => false,
        'force_deactivation' => false,
      ...
      array(
        ...
        'slug'               => 'revslider',
        'source'             => 'https://github.com/vunamhung/TM_Plugins/blob/master/revslider.zip?raw=true',
        'version'            => '4.6.93',
        'required'           => true,
        'force_activation'   => false,
        'force_deactivation' => false,
      ...
      array(
        'name'               => 'Templatera',
        'slug'               => 'templatera',
        'source'             => 'https://github.com/vunamhung/TM_Plugins/blob/master/templatera.zip?raw=true',
        'version'            => '1.1.1',
        'required'           => true,
        'force_activation'   => false,
        'force_deactivation' => false,
    ...
    $config = array(
      ...
      'parent_slug'  => 'thememove',             // Parent menu slug.
