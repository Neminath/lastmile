jQuery(document).ready(function() {
  ...
  function w(a) {
    ...
    jQuery.post(rockAjax.ajaxurl, {selected:b, action:"get_rock_builder_references_list"}, function(b) {
      null != b && (jQuery(".rock-builder-template-list").remove(), jQuery(".rock-builder-actions .template-list-holder").append(b), null != a && void 0 != typeof a && a());
    });
  }
  function q(a) {
    var b;
  ...
  jQuery(document).on("click", "#toggle_page_builder", function() {
    "off" == jQuery(this).attr("mode") ? (jQuery("#wp-content-wrap.wp-editor-wrap").hasClass("tmce-active") || jQuery("#wp-content-editor-tools #content-tmce").trigger("click"), jQuery("#postdivrich").css({visibility:"hidden", position:"relative", height:"0px", overflow:"hidden"}), jQuery("#custom_page").css("display", "block"), jQuery(this).attr("mode", "on"), jQuery(this).val("Close Rock Page Builder")) : (jQuery("#postdivrich").css({visibility:"", position:"", height:"", overflow:""}), jQuery("#custom_page").css("display", 
    "none"), jQuery(this).attr("mode", "off"), jQuery(this).val("Open Rock Page Builder"));
  });
  (function() {
    ...
    jQuery("#wp-content-wrap.wp-editor-wrap").hasClass("tmce-active") || jQuery("#wp-content-editor-tools #content-tmce").trigger("click");
    "true" == (jQuery("#_builder_in_use").is(":checked") ? "true" : "false") && jQuery("#toggle_page_builder").trigger("click");
    var a = jQuery("#toggle_page_builder").parent().width(), a = a - 48;
    ja = parseInt((a - 120) / 12);
    jQuery(".main_page_builder > .gridster").attr("style", "width:" + a + "px");
    jQuery(".main_page_builder").attr("style", "width:" + a + "px");
    a = '<div class="misc-pub-section">' + jQuery(".rockthemes-pb-save-button-container").html() + "</div>";
    jQuery("#major-publishing-actions").before(a);
  ...
  jQuery(document).on("change", ".image_sizes", function() {
    if (jQuery(this).parent().parent().attr("calc") && "true" == jQuery(this).parent().parent().attr("calc")) {
      ...
      if ("no-selected" != b.val()) {
        var b = b.attr("sizes"), b = b.split("x"), b = parseInt(b[0]) + 12, c = parseInt(jQuery(".main_page_builder").attr("layout_width")), d = jQuery("#" + a).find(".boxed_layout").is(":checked") ? "true" : "false", e = jQuery("#" + a.replace("modal", "elem")).parent().parent(), c = c / 12 * parseInt(e.attr("data-sizex")), f = parseInt(jQuery(".main_page_builder").attr("layout_padding")), e = 2 * (2 * f - 3) + 2 * (f - 12) - 16.25;
        d || (e -= 2 * (2 * f - 3));
        f = 767 - e;
        d = 480 - e;
        c = Math.ceil((c - e) / b);
        ...
        jQuery("#" + a + " .block_grid_large").parent().next().append('<div class="recommended_block_grid"><strong><span style="color:#ff0000;">Important ! </span></strong> For chosen image size, using Large Block Grid <strong>' + c + "</strong> or higher strongly recommended. (Calculated without sidebar)</div>");
